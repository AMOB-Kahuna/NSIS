    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 shadow-2xl">
        <div className="flex flex-col items-center justify-center text-center mb-8">
          <div className="p-3 bg-purple-600/20 text-purple-400 rounded-xl mb-3 border border-purple-500/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-900/60 border border-gray-800 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          <button
            ...
            type="submit"
            disabled={loading}
            className="w-full py-2.5 px-4 bg-purple-600 hover:bg-purple-700 disabled:bg-purple-800/50 text-white font-medium rounded-lg shadow-lg hover:shadow-purple-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800/80">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="py-1.5 px-2 bg-gray-900/80 hover:bg-purple-950/30 border border-gray-800 text-purple-400 hover:text-purple-300 rounded text-xs transition-colors cursor-pointer text-center"
            >
              Admin
            </button>
            <button
